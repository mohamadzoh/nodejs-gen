...
function routerTemplate(camelCaseTableName, kebabCaseName, primaryKeys) {
    let template = `const ${camelCaseTableName}Route = require('express').Router();
...
exports.default = routerTemplate;
